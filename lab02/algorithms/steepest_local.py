        ...
        while True:
            ...
            if gain <= 0:
                ...
                if gain == gain_inside and self.variant == "vertices":
                    sel_cycle[first_ver_in], sel_cycle[second_ver_in] = sel_cycle[second_ver_in], sel_cycle[first_ver_in]
                    ...
                    first_cycle[first_ver_out], second_cycle[second_ver_out] = second_cycle[second_ver_out], first_cycle[first_ver_out]
